        ...
        reader.addEventListener('load', function(e) {
            ...
            $(data.log.entries).each(function(index, value){
                ...
                if(entries[2] === "0"){
                    ...
                    $.ajax({
                        dataType: "json",
                        url:'http://ip-api.com/json/'+entries[2],
                        //url: 'http://api.ipstack.com/'+entries[2]+'?access_key=fd83eec28090641e49db6bdc3ea99324' ,//marianna API
                        async: false,//σύγρονα γτ πρέπει να πάρω απάντηση από site
                        success: function(data){
                            entries[7] = data.isp;
                            entries[8] = data.lat;
                            entries[9] = data.lon;
                            //entries[7] = data.connection.isp;
                            //entries[8] = data.latitude;
                            //entries[9] = data.longitude;
                        }
                    });
                }
                ...
                $.ajax({
                    dataType: "json",
                    url:'http://ip-api.com/json/2a02:587:c83f:ae00:ac9e:f5cd:7f5a:501f',
                    //url: 'http://api.ipstack.com/2a02:587:c83f:ae00:ac9e:f5cd:7f5a:501f?access_key=fd83eec28090641e49db6bdc3ea99324',
                    async: false,//σύγρονα γτ πρέπει να πάρω απάντηση από site
                    success: function(data){
                        entries[10] = data.ip;
                        entries[25] = data.lat;
